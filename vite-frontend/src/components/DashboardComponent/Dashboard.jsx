...
function DashboardCard({ title, type, className }) {
    return (
        <>
            <div className={`bg-gray-800 p-6 rounded-lg shadow-lg text-center border border-gray-700 hover:shadow-xl hover:border-purple-500 hover:text-purple-300 transition-all ${className}`} >
